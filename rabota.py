...
while True:
    ...
    if command == 'exit':
        ...
        for line in file.readlines():#четем информаацията от файла и добавяме данните към речника
            line = line.strip()
        ...
        file_name1 = text[1]
        file = open(file_name1, 'w') #отваряме файла за писане и елемнтите и ключовете от речника ги презаписваме там
        for i in d.keys():
            file.write(f"{i}={d[i]}\n")
